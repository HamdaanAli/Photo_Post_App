...
private RecyclerView comment_lsit;
...
private FirebaseAuth firebaseAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment_lsit=findViewById(R.id.comment_list);
        //RecyclerView Firebase List
        commentsList=new ArrayList<>();
        commentsRecyclerAdapter=new CommentsRecyclerAdapter(commentsList);
        comment_lsit.setHasFixedSize(true);
        comment_lsit.setLayoutManager(new LinearLayoutManager(this));
        comment_lsit.setAdapter(commentsRecyclerAdapter);
        ...
        comment_post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!comment_message.isEmpty())
                {
                   ...
                   firebaseFirestore.collection("Post/"+blog_post_id+"/Comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                       @Override
